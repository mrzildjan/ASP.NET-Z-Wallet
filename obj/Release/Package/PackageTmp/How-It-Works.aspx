<%@ Page Title="How It Works" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="How-It-Works.aspx.cs" Inherits="Z_Wallet.How_It_Works" %>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-5">
                        <div class="section-title">
                            ...
                            <h1>See How Wallet Works In Two Minute.</h1>
                            <p>
                            <p>Discover how our e-wallet makes payments seamless in just one minute.</p>
                            <p>Welcome to our e-wallet, where transactions are made easy and hassle-free. No more worries about carrying cash or losing your wallet, because our secure digital wallet has got you covered. </p>
                            <p>Experience a world of seamless payments with our e-wallet today!</p>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-5 mt-lg-0">
                        <div class="has-video-popup position-relative">
                            <img loading="lazy" decoding="async" src="Content/images/video-thumb.png" alt="video thumb" class="rounded-lg w-100">
                            <button type="button" class="video-play-btn border-0 bg-transparent" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/acrKEizHlXI" data-bs-target="#videoModal">
                ...
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-0">
                        <div class="ratio ratio-16x9 rounded-bottom overflow-hidden">
                            <iframe id="showVideo" allowscriptaccess="always" allow="autoplay" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <section class="section ewallet-steps bg-tertiary">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7">
                        <div class="section-title text-center">
                            <p class="text-primary text-uppercase fw-bold mb-3">Register Now</p>
                            <h1>Experience the Future of Payments with Our Effortless Z-Wallet!</h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="step-item col-lg-4 col-md-6">
                                <div class="text-center">
                                    ...
                                    <p class="mb-0">Create an account with us by providing your basic information and verifying your email address or phone number.</p>
                                </div>
                            </div>
                            <div class="step-item col-lg-4 col-md-6">
                                <div class="text-center">
                                    ...
                                    <p class="mb-0">We take security seriously, so we'll need to verify your identity and information before approving your e-wallet account.</p>
                                </div>
                            </div>
                            <div class="step-item col-lg-4 col-md-6">
                                <div class="text-center">
                                    ...
                                    <p class="mb-0">Verify your account and enjoy hassle-free payments, fund transfers, and financial management on-the-go with our e-wallet.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title text-center">
                            ...
                            <p>Enjoy features such as fund transfers, payments, and more, right from your e-wallet. It's easy and convenient!</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="icon-box-item col-lg-4 col-md-6">
                        <div class="block">
                            ...
                            <p class="mb-0">Access your funds and manage your transactions quickly and effortlessly. Our e-wallet offers a seamless payment experience.</p>
                        </div>
                    </div>
                    <div class="icon-box-item col-lg-4 col-md-6">
                        <div class="block">
                            ...
                            <p class="mb-0">Rest assured that your transactions are secure and protected. Our e-wallet employs the latest security measures to safeguard your information.</p>
                        </div>
                    </div>
                    <div class="icon-box-item col-lg-4 col-md-6">
                        <div class="block">
                            ...
                            <p class="mb-0">Join our growing community of satisfied customers who trust our e-wallet for their everyday payment needs.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section bg-tertiary">
            <div class="container">
                <div class="row justify-content-center align-items-center mb-5">
                    <div class="col-lg-6">
                        <div class="section-title text-center">
                            <p class="text-primary text-uppercase fw-bold mb-3">Questions for E-Wallet</p>
                    ...
                    <div class="col-lg-9">
                        <div class="accordion accordion-border-bottom" id="additional_Info">
                            <div class="accordion-item bg-transparent">
                                <h2 class="accordion-header accordion-button h5 border-0 active" id="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9" aria-expanded="true" aria-controls="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9">How do you ensure the security of my transactions and personal information?
                                </h2>
                                <div id="collapse-8a4ed081f8ec73b6e9377f609cffed128b925ed9" class="accordion-collapse collapse border-0 show" aria-labelledby="heading-8a4ed081f8ec73b6e9377f609cffed128b925ed9" data-bs-parent="#additional_Info">
                                    <div class="accordion-body py-0 content">
                                        <p>At Z-Wallet, we take the security of your transactions and personal information very seriously. We use the latest encryption and security technologies to protect your data and prevent unauthorized access.</p>
                                        <p>We also monitor our systems 24/7 to detect and prevent any suspicious activity, and we have a dedicated customer support team available to assist you with any security concerns or questions.</p>
                                    </div>
                                </div>
                            </div>

                            <div class="accordion-item bg-transparent">
                                <h2 class="accordion-header accordion-button h5 border-0 " id="heading-5547386a6e7381108d294d5eebe26d464fcd8c2c" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5547386a6e7381108d294d5eebe26d464fcd8c2c" aria-expanded="false" aria-controls="collapse-5547386a6e7381108d294d5eebe26d464fcd8c2c">Are there any fees for using your e-wallet platform?
                                </h2>
                                <div id="collapse-5547386a6e7381108d294d5eebe26d464fcd8c2c" class="accordion-collapse collapse border-0 " aria-labelledby="heading-5547386a6e7381108d294d5eebe26d464fcd8c2c" data-bs-parent="#additional_Info">
                                    <div class="accordion-body py-0 content">
                                        <p>No, there are no fees for using our e-wallet platform. We believe in providing a convenient and secure payment solution for our users without any hidden charges.</p>
                                    </div>
                                </div>
                            </div>

                            <div class="accordion-item bg-transparent">
                                <h2 class="accordion-header accordion-button h5 border-0 " id="heading-c9475aed4d896279ec43e21b49f55179d31b95ee" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-c9475aed4d896279ec43e21b49f55179d31b95ee" aria-expanded="false" aria-controls="collapse-c9475aed4d896279ec43e21b49f55179d31b95ee">How can I contact your customer support team?
                                </h2>
                                <div id="collapse-c9475aed4d896279ec43e21b49f55179d31b95ee" class="accordion-collapse collapse border-0 " aria-labelledby="heading-c9475aed4d896279ec43e21b49f55179d31b95ee" data-bs-parent="#additional_Info">
                                    <div class="accordion-body py-0 content">
                                        <p>You can contact our customer support team 24/7 through our website or mobile app. We also have a comprehensive FAQ section and user guides available to help answer any questions you may have.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
