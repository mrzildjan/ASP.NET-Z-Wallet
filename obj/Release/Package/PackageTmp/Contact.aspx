<%@ Page Title="Contact Us" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Z_Wallet.Contact" %>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title text-center">
                            ...
                            <p>We'd love to hear from you! If you have any questions, feedback, or just want to say hello, please don't hesitate to reach out to us. You can contact us through our website, email, or social media channels. We look forward to hearing from you and helping you with your e-wallet needs.</p>
                        </div>
                    </div>
                    <div class="col-lg-10">
                            ...
                            <div class="row">
                                    ...
                                    <div class="contact-form">
                                        <form action="#!">
                                            <div class="form-group mb-4 pb-2">
                                                ...
                                                <asp:TextBox ID="contact_name" runat="server" CssClass="form-control shadow-none"></asp:TextBox>
                                            </div>
                                            <div class="form-group mb-4 pb-2">
                                ...
                                <div class="col-lg-6 mt-5 mt-lg-0">
                                    <div class="contact-info">
										...
										<br>
                                                <a href="tel:+639158182091">+639158182091</a>
                                                <br>
                                                Monday - Friday
										<br>
                                                8AM TO 9PM (GMT+8) PH Time
                                            </div>
                                        </div>
                                        <div class="block mt-4">
                                            <h4 class="h5">Cebu City</h4>
                                            <div class="content">
                                                M.J. Cuenco Ave. 
										<br>
                                                Corner R. Palma St.
										<br>
                                                Cebu, Cebu City, Philippines, 6000
                                            </div>
                                            <div class="block">
