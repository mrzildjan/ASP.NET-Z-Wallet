<%@ Page Title="Legal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Legal.aspx.cs" Inherits="Z_Wallet.Legal" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <div class="content">
                            <p>
                                This section includes documents covering the legal terms that apply to various aspects of our operation and services.
    All our subsidiaries will follow rules that are aligned with the documentation presented below, adapted for the specifics
    of its particular jurisdiction.
                            </p>
                            <div class="row">
                                <div class="col-lg-6 mb-4">
                                    <h3 id="e-wallet-user-agreement"><a href="/Terms">E-wallet User Agreement</a></h3>
                                    <p>
                                        This document outlines the terms and conditions governing the use of our e-wallet services. By accessing or using our
                                        services, users agree to comply with these terms and conditions. The user agreement covers various aspects of our
                                        e-wallet services, including account registration, loading of funds, transaction limits, and more.
                                    </p>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <h3 id="privacy-policy"><a href="/Privacy-Policy">Privacy Policy</a></h3>
                                    <p>
                                        This document outlines our policies and procedures regarding the collection, use, and disclosure of personal
                                        information from users of our e-wallet services. We are committed to protecting the privacy of our users and
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <p>
                                        This section provides answers to frequently asked questions about our e-wallet services. If you have any questions or
                                        concerns that are not addressed here, please do not hesitate to contact our customer support team.
                                    </p>
                                </div>
                            </div>
                        </div>
