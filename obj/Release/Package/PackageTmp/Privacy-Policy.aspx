<%@ Page Title="Privacy Policy" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Privacy-Policy.aspx.cs" Inherits="Z_Wallet.Privacy_Policy" %>
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <div class="content">
                            ...
                            <p>You are most welcome to share our e-wallet with your clients/friends, but please share our terms and conditions with them so that they can be aware of our policies.</p>
                            <h3 id="intellectual-property-rights">Intellectual Property Rights</h3>
                            <ul>
                                <li>You cannot copy or modify our e-wallet's code without our permission.</li>
                                <li>You have the right to use our e-wallet for personal and commercial transactions.</li>
                                <li>You cannot resell, redistribute, or sub-license our e-wallet to any third party.</li>
                                <li>You can link to our e-wallet from your website with full credit to us.</li>
                            </ul>
                            <h3 id="the-use-of-the-information">The Use of Information</h3>
                            <ul>
                                <li>We collect personal information such as your name, email address, phone number, and billing address when you sign up for our e-wallet service.</li>
                                <li>We use your personal information to process your transactions and to provide you with customer support.</li>
                                <li>We may also use your personal information for marketing purposes, but you have the right to opt-out of receiving marketing emails from us.</li>
                                <li>We do not share your personal information with third parties except for the purpose of processing your transactions or when required by law.</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>We use encryption technology to protect your sensitive information during transmission.</li>
                                <li>We regularly monitor our systems for vulnerabilities and threats.</li>
                                <li>However, no system is 100% secure and we cannot guarantee the absolute security of your personal information.</li>
                            </ul>
                            <h3 id="changes-to-the-privacy-policy">Changes to the Privacy Policy</h3>
                            <p>We reserve the right to update or modify this privacy policy at any time without prior notice. Please review this policy periodically for any changes. Your continued use of our e-wallet after any modifications to this policy will constitute your acceptance of the updated policy.</p>
                        </div>
                    </div>
                </div>
            </div>
