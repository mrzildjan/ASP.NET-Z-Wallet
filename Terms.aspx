<%@ Page Title="Terms & Conditions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Terms.aspx.cs" Inherits="Z_Wallet.Terms" %>
                ...
                <div class="row">
                    <div class="col-8 mx-auto text-center pt-lg-5">
                        ...
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight: 500">
                            ...
                            <li class="list-inline-item">/ &nbsp; <a href="/Terms">Terms</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <div class="content">
                            <h3 id="the-use-of-the-information">Use of Information</h3>
                            <ul>
                                <li>We collect personal information, such as name, email, and phone number, to provide our services and
              process transactions. This information is kept confidential and is not shared with third parties, except
              when required by law.</li>
                                <li>We use cookies to enhance your browsing experience and personalize content and ads based on your
              interests and preferences.</li>
                                <li>We reserve the right to modify our privacy policy and terms of service at any time. It is your
              responsibility to check for updates.</li>
                            </ul>
                            <h3 id="application-processing">Application Processing</h3>
                            <ul>
                                <li>You may share our services with others, but it is your responsibility to ensure they understand and comply
              with our terms and conditions.</li>
                                <li>We do not guarantee uninterrupted access to our services, as technical issues or maintenance may occur.</li>
                            </ul>
                            <h3 id="what-services-we-render">Services We Offer</h3>
                            <p>
                                We provide an e-wallet platform for secure and convenient cashless transactions. When you sign up for our
            service, you agree to our terms and conditions and allow us to collect and process your personal
            information.
                            </p>
                            <ul>
                                <li>Our platform is only for personal and commercial use, and not for resale or redistribution.</li>
                                <li>You must comply with all applicable laws and regulations when using our service.</li>
                                <li>We reserve the right to terminate your account if you violate our terms and conditions or engage in
              fraudulent or illegal activities.</li>
                            </ul>
                            <h3 id="intellectual-property-rights">Intellectual Property Rights</h3>
                            <ul>
                                <li>All content and materials on our platform, including but not limited to logos, trademarks, and designs,
              are the property of our company and are protected by intellectual property laws.</li>
                                <li>You may not reproduce, distribute, or modify any of our content without our written permission.</li>
                                <li>You may use our platform to host your own content, but you must give us full credit and comply with our
